...
| :--- | :--- |
| **Grid Type** | Cartesian |
| **Layering** | 3-Layer Heterogeneous Model |
| **Porosity** | 0.18 – 0.25 |
| **Permeability** | 50 – 300 mD |
| **Fluid Model** | Black Oil (Correlations-based) |
...
* **Scenario A:** Natural Depletion (Base Case)
* **Scenario B:** Waterflood (Secondary Recovery)

### 2. Production Data Analytics
Exporting simulation results into Excel/Power BI to perform:
* Production rate and pressure trend analysis.
* Water cut behavior diagnostics.
* Identification of early water breakthrough due to reservoir heterogeneity.



### 3. Techno-Economic Analysis
Screening-level evaluation of development costs versus incremental recovery to support engineering decision-making.
...
* **Strategic Thinking:** Evaluating development concepts through a techno-economic lens.
